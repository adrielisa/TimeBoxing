...
const Login: React.FC = () => {
    ...
    const handleLogin = (event: React.FormEvent) => {
      ...
      // Aquí puedes agregar lógica adicional para la autenticación
      navigate('/dashboard');
    };
        ...
        <section className="bg-gray-50 dark:bg-gray-900">
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a href="#" className="flex items-center mb-6 text-2xl font-bold text-gray-900 dark:text-white">
                    <img className="w-8 h-8 mr-2" src="../../public/tarea-completada.png" alt="logo" />
                    TimeBoxing
                </a>
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                ¿No tienes una cuenta? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Crear una</a>
                            </p>
                        </form>
                    </div>
                </div>
